...
class ShewhartChart extends React.Component {
    ...
    renderSvg = () => {
        ...
        // y scale /////////////////////////
        let values = averages.map(d => d.average);
        ...
        averages.forEach(item => {
            ...
            let fill = item.average > upperControlLimit
                ? '#008800'
                : item.average < lowerControlLimit
                    ? '#FF0000'
                    : '#0088FF';
            ...
            plot.append('circle')
                ...
                .attr('cy', () => { return yScale(item.average); })
                .attr('fill', fill)
